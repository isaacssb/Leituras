...
- Concrete Observer - (EmailObserver.php): classes concretas de observadores que são responsáveis por receber notificações de sujeitos concretos (Concrete Subject)
